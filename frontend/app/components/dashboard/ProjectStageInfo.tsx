...
// export const ProjectStageInfo: React.FC<ProjectStageInfoProps> = ({ project }) => {
//   if (!project) {
//     return (
//       <Card className="col-span-1">
//         <CardHeader>
...
//             <AlertCircle className="h-12 w-12 mb-4 text-gray-400" />
//             <p className="mb-2">No project selected</p>
//             <p className="text-sm">Select a project from the search bar to view stage information</p>
//           </div>
//         </CardContent>
//       </Card>
//     );
...
//                 <span className="font-medium">Completed Stages</span>
//               </div>
//               <div className="text-3xl font-bold text-blue-600">{completedStages}</div>
//               <div className="text-sm text-gray-600 mt-1">
...
//                 <span className="font-medium">Remaining Stages</span>
//               </div>
//               <div className="text-3xl font-bold text-yellow-600">{remainingStages}</div>
//               <div className="text-sm text-gray-600 mt-1">
//                 {100 - completionPercentage}% of total
//               </div>
//             </div>
//           </div>
